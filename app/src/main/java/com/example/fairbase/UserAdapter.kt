...
class UserAdapter(
    ...
    private val contant: Context, private val onStudentClickListener:SetOnStudentClickListener
 ):BaseAdapter(){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view=LayoutInflater.from(contant).inflate(R.layout.home_layout_xml,parent,false)
